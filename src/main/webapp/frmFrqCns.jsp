...
//===============================================//
	...
	if (acao == "N") {
		document.form1.txtFranquia.value = "0";
		document.form1.txtAcao.value = "novo";
		document.form1.action = "frmFrqCad.jsp";
	}
	if (acao == "M") {
		if ( document.form1.txtFranquia.value == "0" ) {
			if ( parseInt(document.getElementById("txtLidos").value) > 1 ) {
				document.onkeydown = OnKeyDown;
				document.getElementById("tbPes").getElementsByTagName("tr")[2].click();
			...
			<div class="panel-form w-100">
				...
				<tr>
					<td width="100%" height="100%" align="center" valign="top">
						...
						<tr class="selecF12" height="50"><td class="text-center" colspan="2" valign="top">OFFICE VERIFICATION</td></tr>
						<tr class="selecF12">
							<td colspan="2" >
...
<%
	String strCor1					= 	"#3d3d3d";
	String strCor2					= 	"#525252";
	String	strCor 					= 	strCor2;
	int	iLidos						=	1;
	
	CADFranquias _franquia			=	new CADFranquias( 0L, false, 1, conn );
	while ( _franquia.next() )
	{
		...
		out.write( "\" cor=\"" );
		out.write( strCor );
		out.write( "\" codigo=\"" + _franquia.getId() + "\"><td>" );
		out.write( _franquia.getPais().getNome() );
		out.write("</td><td>" );
		out.write( _franquia.getNome() );
		out.write( "</td><td align=\"center\">" );
		out.write( _franquia.isAtivo() ? "S" : "N&atilde;o" );
		out.write( "</td></tr>\n" );
	}
%>
								</table>
...
function OnClick(e) {
	...
	document.form1.txtFranquia.value = tr.getAttribute("codigo");
	posicaoAnterior = tr;
}
