...
<%@ include file="inc/incNavBar.jsp"%>
			<div class="panel-form w-100 justify-content-center" style="background-color:#121212;">

				<table class="col-12 d-flex justify-content-center" border="0" cellpadding="0" cellspacing="0" width="100%" height="70%" align="center">
				<tr>
					<td class="col-12" align="center" valign="top">
						...
						<tr class="selecF12 col-2" height="50"><td class="col-2 text-center" colspan="2" valign="top">DOLLAR REGISTRATION</td></tr>
						<tr >
							<td class="cabAcesso ">Date:</td>
							<td>
								<input title="Date" onfocus="javascript: window.status=this.title; this.select();" class="input" type="text" value="<%=txtDataBase%>" ths="1" prv="20" nxt="2" id="txtDataBase" name="txtDataBase" onblur="javascript: if (this.value != '') { check_date(this);}" onkeydown="javascript:return verTab(event);" onkeyup="javascript:formataData(event, this);" size="11" maxlength="10">&nbsp;
