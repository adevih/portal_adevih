...
//===============================================//
	...
	if (acao == "D") {
		if ( CampoVazio(document.form1.txtDataPag.value) ) {
			alert("Informe a data base de pagamento para consulta!");
			return;
		}
...
%>
				<table border="0" cellpadding="0" cellspacing="0" width="160%" height="70%" align="center" class="col-12 col-lg-10 m-auto justify-content-center">
<%
		}
		else
		{
%>
				<table border="0" cellpadding="0" cellspacing="0" width="110%" height="70%" align="center" class="col-12 col-lg-10 m-auto justify-content-center">
<%
		}
	}
%>
				<tr>
					<td width="100%" height="100%" align="center" valign="top">
						...
						<tr class="selecF12 col-2" height="50"><td colspan="2" class="col-2 text-center" valign="top">INVESTORS PAYMENT</td></tr>
<%
	if ( intExibir == EXIBIR_PROCURA )
	{
%>
						<tr height="32">
							<td>
								<select class="form-control shadow-sm text-center" name="txtColaborador" id="txtColaborador" ths="1" prv="20" nxt="2" onkeydown="javascript: return verEnter(event);">
<%
...
%>
						...
						<div height="32">
							<td class="col-6"><input class="form-control shadow-sm mt-3 text-center" type="search" name="txtBusca" id="txtBusca" placeholder="Search for Investor" _size="38" ths="2" prv="1" nxt="3" onfocus="javascript: this.select();" value="<%=txtBusca%>" onkeydown="javascript: return verEnter(event);"></td>
							<%-- <td align="center"><input type="button" class="btn btn-dark" value="Cons. Cliente" title="consultar cliente" onclick="javascript: Submeter('C');"></td> --%>
						</div>
						<%-- <tr height="32">
							<td>
						...
						<%-- <tr height="32">
							...
							td align="center"><input type="button" class="btn btn-dark" value="Cons. Data" title="consultar data base" onclick="javascript: Submeter('D');"></td>
						</tr> --%>
						<tr height="30"  _bgcolor="#323232">
							<td colspan="2" valign="bottom">
								<div name="divBtn" id="divBtn" align="center" class="m-2">
									<div align="center" class="mt-2 col-12 col-lg-6 justify-content-center align-items-center d-flex">
										From:
											<input class="form-control-10 text-center" type="text" title="data base de in&iacute;cio para pagamento do contrato" onfocus="javascript: window.status=this.title; this.select();" value="<%=txtDataPag%>" ths="3" prv="2" nxt="4" id="txtDataPag" name="txtDataPag" onblur="javascript: if (this.value != '') { check_date(this);}" onkeydown="javascript:return verEnter(event);" onkeyup="javascript:formataData(event, this);" size="11" maxlength="10">
										To:
											<input class="form-control-10 text-center" type="text" title="data base final para pagamento do contrato" onfocus="javascript: window.status=this.title; this.select();" value="<%=txtDataFin%>" ths="4" prv="3" nxt="1" id="txtDataFin" name="txtDataFin" onblur="javascript: if (this.value != '') { check_date(this);}" onkeydown="javascript:return verEnter(event);" onkeyup="javascript:formataData(event, this);" size="11" maxlength="10">
									</div>
									<div align="center" class="mt-2 d-flex justify-content-center">
										<input type="button" class="btn btn-dark ms-1" value="Ver. Coord." title="Verify Coordinators" onclick="javascript: Submeter('C');">
										<input type="button" class="btn btn-dark mx-2" value="Ver. Date" title="Verify Date" onclick="javascript: Submeter('D');">
										<input type="button" class="btn btn-dark me-1" value="Ver. Investor" title="Verify Investor" onclick="javascript: Submeter('C');">
									</div>
								</div>
...
%>
						<tr>
							<td class="w-100" colspan="2" bgcolor="#323232" align="center">
								<table class="w-100"  border="0" cellpadding="0" cellspacing="1" bgcolor="#525252" name="tbCab" id="tbCab" >
<%
		if ( iWhidt >1 )
		{
%>
								...
								<tr height="26" style="background-color:#323232; color:#000; font-size:0.9em; font-weight: bolder;">
									<td width="20%" align="center">Investor</td>
									<td width="15%" align="right">Contract</td>
									<td width="11%" align="center">Date</td>
									<td width="11%" align="center">Invested</td>
									<td width="10%" align="center">Payed</td>
								</tr>
								<%-- <tr>
									<td width="50%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
									<td width="8%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
						...
						<tr height="30">
							<td colspan="2" valign="bottom" width="100%" align="center">
								<div name="divBtn" id="divBtn" width="100%" align="center" class="mb-4">
									...
									&nbsp;&nbsp;
									<input class="btn btn-dark btn-custom" onclick="javascript: Submeter('M');" type="button" name="btnAcao" value="Verify" ths="20" prv="1" nxt="22" onkeydown="javascript: return verTab(event);">
<%
//	int iAcesso							=	Integer.parseInt(txtAss);
...
%>
									...
									&nbsp;&nbsp;
									<input class="btn btn-dark btn-custom d-none" onclick="javascript: Submeter('N');" type="button" name="btnAcao" value="Novo" ths="22" prv="20" nxt="21" onkeydown="javascript: return verTab(event);">
