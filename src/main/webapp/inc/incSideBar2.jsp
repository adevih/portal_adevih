...
%>
    ...
    <div class="text-center">NETWORK: BEP-20</div>
    <div class="text-center">COIN: USDT</div>
    <img class="m-auto col-8" src="img/qrcode.jpeg">
    <%--  --%>
    <div class="d-flex justify-content-center align-items-end vers" style="height:15vh;"><%=vers%></div>
    </div>
            </ul>
        </nav>
...
<img class=" mb-2 p-2 col-12 align-self-center" style="width:60%;" src="img/logo_responsiva.png"/>
    ...
    <button class="mb-2 p-2 btn btn-outline-light btn-block col-12 me-auto" onclick="Submeter('CliN')">NEW CONTRACT</button>
...
<script>
            <% if(vers == "Development Version" || versT != null){ %>
                this.document.querySelector(".vers").style.color = "red"
            <% } %>
