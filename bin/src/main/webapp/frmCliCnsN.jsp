...
//===============================================//
	...
	if (acao == "M") {
		if ( document.form1.txtContrato.value == "0" || document.form1.txtContrato.value == "" ) {
			alert("Não há contrato selecionado para validar!");
			return;
		}
			...
			<div class="panel-form">
				...
				<tr>
					<td width="100%" height="100%" align="center" valign="top">
						...
						<tr class="selecF12" height="50"><td colspan="2" valign="top">CONTRATOS NOVOS CONSULTA</td></tr>
<%
...
//		CADClienteNovo _cliente			=	new CADClienteNovo( iSelecao, UTLUtils.getStringToLong(txtUid), txtBusca, 0, 0, 0, 0, conn );
		...
		while ( _cliente.next() )
		{
			...
			out.write(_cliente.getSituacaoTitulo());
			out.write("</td></tr>\n");
		}
%>
								</table>
						...
						<tr height="30">
							<td colspan="2" valign="bottom">
								<div name="divBtn" id="divBtn" align="center">
									...
									&nbsp;
									<button class="btn btn-dark btn-custom-3" onclick="javascript: Submeter('M');" type="button" name="btnAcao" value="Validar" ths="20" prv="1" nxt="22" onkeydown="javascript: return verTab(event);">Validar</button>
<%
		if ( iAcesso == CADColaborador.CADASTRO_CONSULTA || iAcesso == CADColaborador.CADASTRO_FRANQUIA )
		{
%>
