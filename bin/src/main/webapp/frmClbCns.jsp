			...
			<div class="panel-form">
				...
				<tr>
					<td width="100%" height="100%" align="center" valign="top">
						...
						<tr class="selecF12" height="50"><td colspan="2" valign="top"><!--img src="img/user_edit.png" alt="">&nbsp;-->COORDENADOR CONSULTA</td></tr>
<%
						...
						<tr height="30">
							<td colspan="2" valign="bottom">
								<div name="divBtn" id="divBtn" align="center" class="mb-4">
									<br>
									<input class="btn btn-dark btn-custom" onclick="javascript: Submeter('C');" type="button" name="btnAcao" value="Consultar" ths="20" prv="1" nxt="22" onkeydown="javascript: return verTab(event);">
									&nbsp;
...
%>
						...
						<tr height="30">
							<td colspan="2" valign="bottom">
								<div name="divBtn" id="divBtn" align="center" class="mb-4">
									<br>
									<input class="btn btn-dark btn-custom-3" type="button" name="btnAcao" onclick="javascript: Submeter('V');" value="Voltar" ths="21" prv="22" nxt="23" onkeydown="javascript: return verTab(event);">
									&nbsp;
