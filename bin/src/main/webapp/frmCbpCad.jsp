...
<!-- --------------------------------------------------------------Paginação: Fim Parte 1 de 5 -->
						...
						<tr class="selecF12" height="50"><td colspan=2" valign="top">PAGAMENTOS COORDENADOR CADASTRO</td></tr>
						<tr >
							<td colspan="2">
<%
							...
							<div name="divProg" id="divProg" style="height: 240; width: 100%; overflow: auto; display:block; overflow-y: scroll;">
								<table width="100%" border="0" cellpadding="0" cellspacing="1" name="tbCab" id="tbCab">
									<tr bgcolor="#ffffff">
										...
										<td width="6%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
...
%>
							...
							<div name="divProg" id="divProg" style="height: 240; width: 100%; overflow: auto; display:block; overflow-y: scroll;">
								<table width="100%" border="0" cellpadding="0" cellspacing="1" name="tbCab" id="tbCab">
									<tr bgcolor="#ffffff">
										<td width="64%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
										<td width="8%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
										<td width="8%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
										<td width="9%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
										<td width="8%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td>
...
//		out.write( " txtFnq=\"" + _pagamento.getContrato().getFranquiaTitulo() + "\" " );
	...
	// ------------------------------------------------------------------------------------------------------------------
	// Calcular os valores em reais e dolar - Início		
			if ( _pagamento.getIdMoeda() == 0 )
			{
...
*/
		...
		{
			out.write( "" );
			out.write("<input type=\"checkbox\" name=\"txtPagar\" value=\"" + _pagamento.getId() + "\" id=\"pg" + iLidos + "\" title=\"confirmar pagamento\">");
...
%>									
						...
						<tr class="cabAcesso" >
							<td>Coordenador:</td>
							<td><input class="form-control shadow-sm" style="background-color: #e6e6e6;" type="text" name="txtCoord" id="txtCoord" size="50" onfocus="javascript: this.blur();" value="" onkeydown="javascript: return false;"></td>
						</tr>
						<tr class="cabAcesso" >
							...
							<td>
								...
								<div class="grupo-coluna-l">
								<input class="form-control shadow-sm col-lg-11" style="background-color: #e6e6e6;" ype="text" name="txtIdt" id="txtIdt" size="15" onfocus="javascript: this.blur();" value="" onkeydown="javascript: return false;">
								</div>
								</div>
							</td>
						</tr>
						...
						<tr class="cabAcesso" >
							...
							<td>
								...
								<div class="grupo-coluna-3">
								<input class="form-control shadow-sm col-lg-11" style="background-color: #e6e6e6;" type="text" name="txtMss" id="txtMss" size="4" value="" onfocus="javascript: this.blur();" onkeydown="javascript: return false;">
								</div>
								<div class="grupo-coluna-3">
						...
						<tr class="cabAcesso" >
							<td>Chave PIX:</td>
							<td><input class="form-control shadow-sm" type="text" name="txtPix" id="txtPix" size="50" onfocus="javascript: copyToClipboard(this.value); this.select();" value="" txt="" onkeydown="javascript: return false;" Xonblur="if (this.value != this.getAttribute('txt')) this.value = getAttribute('txt');"></td>
						</tr>
						<tr class="cabAcesso" >
							<td>End.Carteira:</td>
							<td><input class="form-control shadow-sm" type="text" name="txtEnc" id="txtEnc" size="50" onfocus="javascript: copyToClipboard(this.value); this.select();" value="" txt="" onkeydown="javascript: return false;" Xonblur="alert(this.getAttribute('txt')); if (this.value != this.getAttribute('txt')) this.value = getAttribute('txt');"></td>
						</tr>
						<tr height="30">
