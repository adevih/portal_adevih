...
Calendar.prototype.show = function() {
	...
	this.wwriteA("<select style=\"background-color:'#f0f8ff'; width:130px;\" name=meses onchange=\"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "',document.form1.meses[document.form1.meses.selectedIndex].value ,document.form1.anos[document.form1.anos.selectedIndex].value,'" + this.gFormat + "'" + ");\">");
...
Calendar.prototype.cal_header = function() {
	...
	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sáb</B></FONT></TD>";
	vCode = vCode + "</TR>";
	return vCode;
}
