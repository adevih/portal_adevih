...
%>
                <li>
                    <a href="#" title="manuten&ccedil;&atilde;o do cadastro de clientes" onclick="Submeter('CliN'); return false;"><img class="g-2" src="img/cliente.png" width="20"/> CLIENTE NOVO</a>
                </li>
                <li>
