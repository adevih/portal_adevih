...
<!-- --------------------------------------------------------------Paginação: Fim Parte 1 de 5 -->
						...
						<tr class="selecF12" height="50"><td colspan=2" valign="top">PAGAMENTOS COORDENADOR CONSULTA</td></tr>
<%
...
%>
						<tr height="32" >
							<td>
								<select class="form-control shadow-sm" name="txtColaborador" id="txtColaborador" _style="background-color: #f0f8ff" ths="1" prv="20" nxt="2" onkeydown="javascript: return verEnter(event);">
<%
	...
	{
		out.write("<option value=\"-2\">SEM COORDENADOR</option>");
	}
...
%>
							...
							<td><input type="button" class="btn btn-dark" value="..." title="consultar coordenador" onclick="javascript: Submeter('C');"></td>
						</tr>
						<tr height="32" >
							<td>
								...
								<tr width="100%">
									<td width="40%">
										Data in&iacute;cio:&nbsp;<input class="form-control-30" type="text" title="data base de pagamento do contrato" onfocus="javascript: window.status=this.title; this.select();" value="<%=txtDataPag%>" ths="3" prv="2" nxt="4" id="txtDataPag" name="txtDataPag" onblur="javascript: if (this.value != '') { check_date(this);}" onkeydown="javascript:return verEnter(event);" onkeyup="javascript:formataData(event, this);" size="11" maxlength="10">
									</td>
									<td width="60%" valign="middle">
										&nbsp;<img src="img/calendario.gif" width="22" height="21" border="0" style="cursor: pointer; align:left; valign:middle;" id="imgDataCadastro" alt="data base in&iacute;cio para pagamento da comiss&atilde;o" align="absmiddle" onMouseOver="javascript: window.status='Data base de pagamento do contrato';return true;" onMouseOut="javascript: window.status='';return true;">
									</td>
								</tr>
								</table>
							</td>
...
%>
								<tr>
									...
									<!--td width="24%"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td-->
...
<!-- --------------------------------------------------------------Paginação: Inicio Parte 5 de 5 -->
								<table border="0" cellpadding="0" cellspacing="0" bgcolor="#d9d9d9" width="100%">
									<tr height="1"><td width="100%" bgcolor="#fff"><img src="img/trans1x1.gif" width="100%" height="1" alt=""></td></tr>
