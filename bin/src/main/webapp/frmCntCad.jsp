...
/*     Verificar a exclusão dos pagamentos do contrato;				*/
			if ( txtAlt.equals("S") )
			{
...
<script type="text/Javascript">
// -------------------------- Taxa de Remuneração/Comissão do novo contrato  --------------------------------- //
function buscarTaxa() {
...
// -------------------------- Cálculo do Dolar do novo contrato  --------------------------------------------- //
function findDolar() {
// Campos:
// 	data = data base para pesquisa, se igual branco, busca a data atual;
// 	dias = dias anteriores à "data", se não informar, busca até 4 dias;
